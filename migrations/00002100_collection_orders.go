// Migration for collection: /api/orders orders - Orders - Successfully retrieved list of orders with pagination details
package migrations
...
func init() {
	migrations.Register(func(app core.App) error {
		...
		ordersCol, err := app.FindCollectionByNameOrId("orders")
		if err != nil {
			ordersCol = core.NewBaseCollection("orders")
		}
		ordersCol.ListRule = types.Pointer("")
		ordersCol.ViewRule = types.Pointer("")
		...
		if err := app.Save(ordersCol); err != nil {
			return err
		}
		return nil
	}, nil)
