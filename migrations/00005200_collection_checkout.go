// Migration for collection: /api/checkout - Checkout - PhonePe payment session successfully created
package migrations
...
func init() {
	migrations.Register(func(app core.App) error {
		...
		phonepeCol, err := app.FindCollectionByNameOrId("checkout")
		if err != nil {
			phonepeCol = core.NewBaseCollection("checkout")
		}
		phonepeCol.ListRule = types.Pointer("")
		phonepeCol.ViewRule = types.Pointer("")
		phonepeCol.Fields.Add(
			...
			&core.NumberField{Name: "discount"},
			&core.NumberField{Name: "tax"},
			&core.TextField{Name: "currencySymbol"},
			&core.TextField{Name: "currencyCode"},
			&core.NumberField{Name: "codCharges"},
			&core.NumberField{Name: "codPaid"},
			...
			&core.NumberField{Name: "amountRefunded"},
			&core.NumberField{Name: "amountDue"},
			&core.NumberField{Name: "amountPaid"},
			&core.NumberField{Name: "totalDiscount"},
			&core.NumberField{Name: "totalAmountRefunded"},
			...
			&core.NumberField{Name: "paymentAmount"},
		...
		if err := app.Save(phonepeCol); err != nil {
			return err
		}
		return nil
	}, nil)
