...
func init() {
	migrations.Register(func(app core.App) error {
		...
		if err != nil {
			cartsCol = core.NewBaseCollection("carts")
		}
		...
		cartsCol.Fields.Add(
			...
			&core.NumberField{Name: "discountAmount", Required: true},
			...
			&core.NumberField{Name: "shippingCharges", Required: true},
			&core.TextField{Name: "paymentMethod"},
			&core.TextField{Name: "shippingMethod"},
			&core.NumberField{Name: "subtotal", Required: true},
			&core.NumberField{Name: "codCharges", Required: true},
			&core.NumberField{Name: "tax", Required: true},
			&core.NumberField{Name: "total", Required: true},
			&core.NumberField{Name: "savingAmount", Required: true},
			...
			&core.NumberField{Name: "currencyDecimalDigits"},
		...
		if err := app.Save(cartsCol); err != nil {
			return err
		}
		return nil
	}, nil)
